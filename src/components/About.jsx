export default function About() {
  return (
  <div id="about" className="py-20 section-bg-4">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <span className="text-neutral-800 font-semibold">Von der erschöpften Hobbysportlerin zur Expertin für Sporternährung</span> – 
            ...
            <div className="space-y-12">
              ...
              <div id="story-2012" className="relative flex items-center animate-slide-in-left">
                ...
                <div className="ml-12 md:ml-0 md:w-1/2 md:pr-8">
                  <div className="">
                    <div className="text-sm text-neutral-700 font-semibold mb-2">2012 - Der Wendepunkt</div>
              ...
              <div className="relative flex items-center animate-slide-in-left">
                ...
                <div className="ml-12 md:ml-0 md:w-1/2 md:pr-8">
                  <div className="">
                    <div className="text-sm text-neutral-700 font-semibold mb-2">2018 - Die Mission beginnt</div>
        ...
        <div className="lg:grid lg:grid-cols-2 lg:gap-16 lg:items-start mb-20">
          ...
          <div className="mt-10 lg:mt-0">
            <div className="prose prose-lg text-gray-600 max-w-none">
              {/* Flattened: removed card background, border, shadow, blur */}
              <div className="p-8 mb-8 animate-fade-in-up">
  ...
  <div className="mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center transition-all duration-300 animate-scale-in">
            ...
            <div className="text-center transition-all duration-300 animate-scale-in" style={{animationDelay: '0.1s'}}>
            ...
            <div className="text-center transition-all duration-300 animate-scale-in" style={{animationDelay: '0.2s'}}>
              <div className="w-16 h-16 bg-primary-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-neutral-700" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center transition-all duration-300 animate-scale-in" style={{animationDelay: '0.3s'}}>
              <div className="w-16 h-16 bg-accent-100 rounded-full flex items-center justify-center mx-auto mb-4">
                <svg className="w-8 h-8 text-accent-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {/* Enhanced Philosophy */}
  {/* Flattened Philosophy: removed overlay and card styling */}
  <div className="mb-16 text-neutral-800 animate-fade-in-up">
  ...
  <div className="mb-12 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="transition-all duration-300 animate-scale-in">
            <div className="text-5xl font-bold text-neutral-900 mb-2">200+</div>
          ...
          <div className="transition-all duration-300 animate-scale-in" style={{animationDelay: '0.1s'}}>
            <div className="text-5xl font-bold text-neutral-900 mb-2" style={{animationDelay: '0.2s'}}>12</div>
          ...
          <div className="transition-all duration-300 animate-scale-in" style={{animationDelay: '0.2s'}}>
            <div className="text-5xl font-bold text-neutral-900 mb-2" style={{animationDelay: '0.4s'}}>25+</div>
  ...
  <div className="animate-fade-in-up">
        ...
        <div className="mt-16 text-center">
          <div className="p-0 text-neutral-900">
            ...
            <a href="#contact" className="inline-flex items-center px-8 py-4 bg-neutral-900 text-white font-semibold rounded-xl hover:bg-neutral-700 transition-colors">
